...
$(MEM_0)_END := 0x0003aa7d
$(MEM_0)_SPAN := 0x0003aa7e
$(MEM_0)_HIERARCHICAL_PATH := audio_rom
$(MEM_0)_WIDTH := 16
...
.PHONY: audio_rom
audio_rom: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_0
MEM_1 := audio_system_onchip_memory2_0
...
$(MEM_1)_START := 0x000c0000
$(MEM_1)_END := 0x000c7ffe
